...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    foreach ($dados as $campo => $valor) {
        if (in_array($campo, ["destaque", "proximo_lancamento", "ativo"], true)) {
    ...
    if (
        $dados["categoria_id"] === ""
        || filter_var($dados["categoria_id"], FILTER_VALIDATE_INT) === false
    ) {
        $erros[] = "Seleciona uma categoria.";
    }
...
<head>
    ...
    <title>Novo produto — GamerHub Admin</title>
    ...
    <style>
        ...
        .alert-custom{margin-bottom:1rem;padding:1rem;border:1px solid rgba(255,92,110,.35);border-radius:.8rem;background:rgba(220,53,69,.14);color:#ff9ba5}
...
<div class="admin-shell">
    ...
    <main class="admin-main">
        <header class="admin-header">
            <div><span>Gestão da loja</span><h1>Novo produto</h1></div>
        ...
        <form method="post" class="form-card">
            <div class="form-grid">
                ...
                <div class="form-field full">
                    ...
                    <input id="imagem" name="imagem" value="<?= htmlspecialchars($dados["imagem"]) ?>" placeholder="assets/images/products/.../imagem.jpg">
                </div>
                ...
                <div class="form-field">
                    ...
                    <input id="plataforma" name="plataforma" value="<?= htmlspecialchars($dados["plataforma"]) ?>" placeholder="PC, PS5, Xbox...">
                </div>
                ...
                <div class="form-field">
                    ...
                    <input id="pegi" name="pegi" value="<?= htmlspecialchars($dados["pegi"]) ?>" placeholder="3, 7, 12, 16, 18">
                </div>
            </div>

            <div class="checkboxes">
                <label><input type="checkbox" name="destaque" value="1" <?= $dados["destaque"] ? "checked" : "" ?>> Destaque</label>
                <label><input type="checkbox" name="proximo_lancamento" value="1" <?= $dados["proximo_lancamento"] ? "checked" : "" ?>> Próximo lançamento</label>
                <label><input type="checkbox" name="ativo" value="1" <?= $dados["ativo"] ? "checked" : "" ?>> Ativo</label>
            </div>

            <div class="actions">
                <a href="produtos.php" class="btn btn-outline-light">Cancelar</a>
                <button type="submit" class="btn-purple"><i class="bi bi-check2"></i> Criar produto</button>
            </div>
        </form>
    </main>
</div>
